...
* Fork from alexreisner, changed to use Google Map API v3, added 2 customized functions fetch_all and fetch_all!
* Set default unit to km when using in China, default language out put to Simplified Chinese, using JSON instead of xml parse
